...
const api = {
  ...
  getDataSourceById(sourceId: string): Promise<DataSourceTypeDTO> {
    return new Promise<DataSourceTypeDTO>((resolve, reject) => {
      const mockDataSource: DataSourceTypeDTO = {
        id: sourceId,
  ...
  createDataSource(dataSource: Omit<DataSourceTypeDTO, 'id'>) {
